...
FROM 600897147573.dkr.ecr.us-west-2.amazonaws.com/maven:3.9.5-eclipse-temurin-17 as build
...
FROM 600897147573.dkr.ecr.us-west-2.amazonaws.com/tomcat:9.0-jdk17
